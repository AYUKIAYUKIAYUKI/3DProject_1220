...
void SetInfoGauge(void)
{
	for (int i = 0; i < TexMax; i++)
	{
		...
		{
			g_aGauge[i].pos = D3DXVECTOR3(1150.0f, 75.0f, 0.0f);
		...
		{
			g_aGauge[i].pos = D3DXVECTOR3(g_aGauge[TexGauge01].pos.x - g_aGauge[TexGauge01].sizeX, g_aGauge[TexGauge01].pos.y - 5.0f, 0.0f);
